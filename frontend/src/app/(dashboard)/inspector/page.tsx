    ...
    <DashboardLayout userRole="inspector">
      <div className="p-6 bg-gray-100 min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Welcome back, {user?.firstName || 'Inspector'}! Here's your application overview</p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <button className="p-4 bg-white rounded-lg shadow-sm border border-gray-100 hover:border-[#224057] transition-colors">
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-sm font-medium">Inspection</span>
              </div>
            </button>
          </div>
        </div>
